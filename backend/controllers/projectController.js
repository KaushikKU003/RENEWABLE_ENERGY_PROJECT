...
router.get("/projects/:id", (req, res) => {
  try {
    ...
    const sql = `
      SELECT project_name, type, start_date, status, capacity, location_name,longitude,latitude, country,organization_name,organization_type,contact_info, total_cost,funding_source, revenue_generated,co2_reduction,other_benifits,impact,Likelihood,risk_description
      FROM project p
