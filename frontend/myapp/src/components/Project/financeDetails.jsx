  ...
  return (
    ...
    <div className="bg-[#f8f5f5] p-8 rounded-lg shadow-md w-full max-w-[50%] mx-auto mt-10">
      ...
      <div>
        ...
        <input type="number" id="total_cost" name="total_cost" value={financeDetails.total_cost} onChange={handleInputChange} className="shadow appearance-none border rounded w-full py-2 px-3 mb-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" />
      </div>
      <div>
        <label htmlFor="funding_source" className="block text-gray-700 text-sm font-bold mb-2">Project Funding Source:</label>
        <input type="text" id="funding_source" name="funding_source" value={financeDetails.funding_source} onChange={handleInputChange} className="shadow appearance-none border rounded w-full py-2 px-3 mb-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" />
      </div>
      <div>
      ...
      <div>
        <label htmlFor="return_on_investment" className="block text-gray-700 text-sm font-bold mb-2">Return Of Investement (%):</label>
        <input type="number" id="return_on_investment" name="return_on_investment" value={financeDetails.return_on_investment} onChange={handleInputChange} className="shadow appearance-none border rounded w-full py-2 px-3 mb-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"  />
      </div>
