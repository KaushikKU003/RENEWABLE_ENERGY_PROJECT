...
const ProjectBenefits = () => {
    ...
    <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-[50%] mx-auto mt-10">
      <h1 className="text-2xl font-semibold mb-6 text-center">Benefits Details</h1>
      <form class='max-w-[75%] m-auto ' onSubmit={handleSubmit}>
      <div>
        <label htmlFor="co2_reduction" className="block text-gray-700 text-sm font-bold mb-2">Project CO2 Reduction Percentage:</label>
